...
import random
from reid.dist_metric import re_ranking
...
class RandomIdentitySampler(Sampler):
    ...
    def __init__(self, data_source, num_instances=4):
        ...
        for index, (imgs, pid, _,_) in enumerate(data_source):
...
class EUG():
    def __init__(self, model_name, batch_size, mode, num_classes, data_dir, l_data, u_data, save_path, dropout=0.5, max_frames=32):
    ...
    def get_dataloader(self, dataset, training=False) :
        ...
        data_loader = DataLoader(
            ...
            shuffle=training, pin_memory=False, drop_last=training)
    ...
    def get_Dissimilarity_result_rank(self):
        ...
        dist = re_ranking(u_l_dist,u_u_dist,l_l_dist)
    ...
    def generate_new_train_predict_data(self, sel_idx, pred_y):
        """ generate the next training data """
